...
class DatabaseManager:
    def __init__(self, 
        ...
        self.conn_params = {
            ...
            "dbname": dbname or os.getenv("DB_NAME", "clip_search")
        }
        self.table_name = "moonvit_embeddings"
        self._init_db()
    ...
    def _init_db(self):
        """Initializes the database schema for MoonViT embeddings."""
        ...
        # Table with MoonViT (1152), color (3), and texture (32) vectors
        cur.execute(f"""
    ...
    def save_embedding(self, filename, embedding, color_rgb=None, texture_vec=None):
        """Inserts or updates a MoonViT embedding, color, and texture."""
